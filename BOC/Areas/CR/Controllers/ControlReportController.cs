...
{
    [Area("CR")]
    public class ControlReportController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnvironment;
        private readonly IConfiguration configuration;
        private readonly IFileProvider fileProvider;
        public ControlReportController(IWebHostEnvironment webHostEnvironment, IConfiguration configuration, IFileProvider fileProvider)
        {
        ...
        public IActionResult CreateReport(string FltNo,string Route,string Aircraft,string Reg,string Date,string FlightID)
        {
          
            ViewBag.FlightDate = DateTime.Parse(Date).ToShortDateString();
            ViewBag.FlightNo = FltNo;
            ViewBag.Route = Route;
            ViewBag.FlightID = FltNo;
        ...
        public IActionResult FlightGet(ControlReportModel model)
        {
            ...
            {
                model.ErrorMessage = "FromDate must be equal or smaller than ToDate!";
            }

            return View(model);
        }

        public IActionResult ReportList(ReportListModel model)
        {
